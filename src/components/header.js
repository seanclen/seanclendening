      ...
      <div className="nav">
        <div className={"navbar-menu " + isActiveClass}>
          ...
          <div className="navbar-end">
            <p className="subtitle m-b-0 is-size-6"><strong className="has-text-primary">Sean Clendening</strong></p>
      ...
      <nav className={"navbar is-spaced is-transparent is-fixed-top " + isNavToggledClass} role="navigation" aria-label="main navigation">
        <div className="navbar-brand">
          <figure className={'logo-container' + isPreloaderVisibleClass + isNavToggledClass}>
            <a className='click-box' href={rootPath}></a>
            <svg viewBox="0 0 48 48" height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g id="logo" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                ...
                <rect id="logoPeriod" fill="#468C7F" x="31" y="28" width="7" height="7"></rect>
                <g id="logoHelloText">
                  <text className="logoHelloChar" x="38" y="26.5" fill="#FFFFFF" transform="rotate(90 40,20)" fontFamily="monospace" fontSize="0.2em">H</text>
                  <text className="logoHelloChar" x="39.95" y="26.5" fill="#FFFFFF" transform="rotate(90 40,20)" fontFamily="monospace" fontSize="0.2em">e</text>
                  <text className="logoHelloChar" x="41.9" y="26.5" fill="#FFFFFF" transform="rotate(90 40,20)" fontFamily="monospace" fontSize="0.2em">l</text>
                  <text className="logoHelloChar" x="43.85" y="26.5" fill="#FFFFFF" transform="rotate(90 40,20)" fontFamily="monospace" fontSize="0.2em">l</text>
                  <text className="logoHelloChar" x="45.8" y="26.5" fill="#FFFFFF" transform="rotate(90 40,20)" fontFamily="monospace" fontSize="0.2em">o</text>
                </g>
                <rect id="logoHelloCursor" fill="#FFFFFF" x="33" y="18" width="3" height="2"></rect>
